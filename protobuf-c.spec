...
Source0  : https://github.com/protobuf-c/protobuf-c/releases/download/v1.3.3/protobuf-c-1.3.3.tar.gz
...
%prep
%setup -q -n protobuf-c-1.3.3
cd %{_builddir}/protobuf-c-1.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609783246
unset LD_AS_NEEDED
...
cp %{_builddir}/protobuf-c-1.3.3/LICENSE %{buildroot}/usr/share/package-licenses/protobuf-c/7497f724cc1f1ee84e4ced1f6a59e2d39793a231
%make_install
